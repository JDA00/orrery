#!/usr/bin/env python3
"""
Get JPL Horizons data in ecliptic coordinates (to match VSOP87A output).
"""

import subprocess
import re

def get_jpl_ecliptic(body_id, body_name):
    """
    Get position/velocity from JPL Horizons in ecliptic frame.
    """
    ...
    cmd = [
        ...
        '--data-urlencode', f"CENTER='@sun'",  # Heliocentric
...
print("# Reference Frame: J2000.0 Ecliptic (matching VSOP87A output)")
...
for body_id, name in planets:
    ...
    data = get_jpl_ecliptic(body_id, name)
